...
***[Alignments](https://igv.org/web/release/2.10.5/examples/cram-vcf.html)***

***[Interactions](https://igv.org/web/release/2.10.5/examples/interact.html)***

***[Copy number](https://igv.org/web/release/2.10.5/examples/copyNumber.html)***

***[Multiple regions](https://igv.org/web/release/2.10.5/examples/multi-locus.html)***

***[Mutation Annotation Format (MAF)](https://igv.org/web/release/2.10.5/examples/maf-tcga.html)***

***[Variant color options](https://igv.org/web/release/2.10.5/examples/variant-colors.html)***

***[More](https://igv.org/web/release/2.10.5/examples/)***
...
can be downloaded from [https://cdn.jsdelivr.net/npm/igv@2.10.5/dist/](https://cdn.jsdelivr.net/npm/igv@2.10.5/dist/). 
